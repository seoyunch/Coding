-- 코드를 입력하세요
SELECT USED_GOODS_BOARD.TITLE, USED_GOODS_REPLY.BOARD_ID, USED_GOODS_REPLY.REPLY_ID, USED_GOODS_REPLY.WRITER_ID, USED_GOODS_REPLY.CONTENTS, USED_GOODS_REPLY.CREATED_DATE
